...
function _getIssueDate (index, isLastIssue, hostPublicationDateByVolume, publicationDateByVolume) {
  ...
  return _.chain(hostPublicationDateByVolume[index]['host.publicationDate'].buckets)[position]()
    .get('keyAsString', _.chain(publicationDateByVolume[index].publicationDate.buckets)[position]()
      .get('keyAsString', null)
      .value())
    .value()
  ;
